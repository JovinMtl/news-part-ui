            ...
            <section id="home" class="hero-gradient py-16 md:py-28 overflow-hidden relative scroll-mt-24">
                ...
                <div class="container mx-auto px-4 relative">
                    <div class="flex flex-col lg:flex-row items-center">
                        ...
                        <div class="lg:w-1/2">
                            <div class="relative fade-in" style="transition-delay: 0.1s">
    ...
    // createApp({
        // data() {
            // return {
                ...
                // scrolled: false,
                // animatedStats: { youthReached: 0, programs: 0, countries: 0, satisfaction: 0 },
                // statsTargets: { youthReached: 12500, programs: 320, countries: 45, satisfaction: 98 },
                // statsStarted: false,
                // showVideo: false,
                // videoSrc: '',
                // email: '',
        ...
        //     // Close video on ESC
        //     window.addEventListener('keydown', (e) => {
        //         if (e.key === 'Escape' && this.showVideo) this.closeVideo();
        //     });
        // },
        // methods: {
            ...
            //     Object.keys(this.statsTargets).forEach(stat => {
            //         const target = this.statsTargets[stat];
            //         const stepValue = target / steps;
            //         let current = 0;
            ...
            //                 clearInterval(timer);
            //             } else {
            //                 this.animatedStats[stat] = Math.floor(current);
            //             }
            //         }, interval);
            //     });
            // },
            ...
            //     setTimeout(() => { this.subscribed = false; this.email = ''; }, 3500);
            // }
        // }
    // }).mount('#app');
</script>
